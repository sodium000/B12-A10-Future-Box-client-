...
const Highlights = () => {
  ...
  return (
    <section className="py-16 px-6 bg-[url(/abstract-textured-backgound.jpg)] bg-cover bg-center bg-no-repeat">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-pink-700">
            ...
            <div className="space-y-4">
              {highlights.map((highlight, index) => (
                ...
                >
                  ...
                  <span className="text-gray-200 text-lg">{highlight}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
